...
class resunit(nn.Module):
    def __init__(self, inputChannels, outputChannels, direction):
        ...
        #     nn.ReLU(inplace=True),
        # )
        self.conv3 = conv3(self.inputChannels  *2, self.outputChannels)
...
class uNet(nn.Module):
    def __init__(self, respart = resunit):
        ...
        # encoder conv
        self.conv3Down_1 = conv3(1,32)  #Designed for grayscale images
        self.conv3Down_2 = conv3(512,256)
        # self.conv3Down_3 = conv3(128,256)
        # self.conv3Down_4 = conv3(256,512)
        # decoder conv
        self.conv3Up_1 = conv3(32, 1)
        ...
        # encoder resunit
        self.resunitDown_1 = respart(32, 64,0)
        self.resunitDown_2 = respart(64,128 ,0)
        self.resunitDown_3 = respart(128,256 ,0)
        self.resunitDown_4 = respart(256,512,0)
        # decoder resunit
        self.resunitUp_1 = respart(512,128 ,1)
        self.resunitUp_2 = respart(256,64 ,1)
        self.resunitUp_3 = respart(128,32 ,1)
    ...
    def forward(self, x):
        ...
        xEncoder1_2 = self.resunitDown_2(xEncoder1_0)
        xEncoder2_0 = self.downPool_2(xEncoder1_2)
        # xEncoder2_1 = self.conv3Down_3(xEncoder2_0)
        xEncoder2_2 = self.resunitDown_3(xEncoder2_0)
        xEncoder3_0 = self.downPool_3(xEncoder2_2)
        xEncoder3_1 = self.resunitDown_4(xEncoder3_0)
        xEncoder3_2 = self.conv3Down_2(xEncoder3_1)
        # print(xEncoder3_2.shape)

        # decoder part

        # xDecoder0_0 = self.resunitUp_1(xEncoder3_1)
        xDecoder1_0 = self.deconv_1(xEncoder3_2)
        # print((xDecoder1_0.shape,xEncoder2_2.shape))
        xDecoder1_1 = self.resunitUp_1(torch.cat([xEncoder2_2, xDecoder1_0],1))
        # xDecoder1_2 = self.conv3Up_1(xDecoder1_1)
        xDecoder2_0 = self.deconv_2(xDecoder1_1)
        xDecoder2_1 = self.resunitUp_2(torch.cat([xEncoder1_2, xDecoder2_0],1))
        # xDecoder2_2 = self.conv3Up_2(xDecoder2_1)
        xDecoder3_0 = self.deconv_3(xDecoder2_1)
        xDecoder3_1 = self.resunitUp_3(torch.cat([xEncoder0_2, xDecoder3_0],1))
        xDecoder3_2 = self.conv3Up_1(xDecoder3_1)
