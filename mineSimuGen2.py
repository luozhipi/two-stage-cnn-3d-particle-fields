...
isaveFilePath = './hologramPath/dataset/traindata2/'
psaveFilePath = './hologramPath/dataset/truth2/'
tsaveFilePath = './hologramPath/dataset/'
zsaveFilePath = './hologramPath/dataset/'
saveCsvFileName = 'trainDataInfo2.csv'
bgIntensity = 2
imgNum = 5200 #每个类别100张，总共52个类别
