...
class resunit(nn.Module):
    def __init__(self, inputChannels, outputChannels, direction):
        ...
        self.branch2 = nn.Sequential(
            nn.BatchNorm2d(branchChannels),
            nn.ReLU(inplace=True),
            nn.Conv2d(branchChannels, branchChannels, kernel_size=(1, 1), stride=(1, 1), bias=False, padding=0),
            nn.BatchNorm2d(branchChannels),
            nn.ReLU(inplace=True),
            nn.Conv2d(branchChannels, branchChannels, kernel_size=(3, 3), stride=1, padding=1, bias=False, groups=branchChannels),
            nn.BatchNorm2d(branchChannels),
